  ...
  return (
    <div>
      ...
      <div className="relative z-10 mt-5 m-3">
        <motion.div
          className={`animate-fadeIn ml-13 backdrop-blur-md md:mx-auto mt-10 w-12/15 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ${user ? "md:ml-55" : ""
            }`
          }
          initial="hidden"
          animate="visible"
