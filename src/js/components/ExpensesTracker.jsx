  ...
  return (
    <div className="relative min-h-screen w-full overflow-y-auto">
      ...
      {/* Contenido */}
          ...
          <h1 className="titulo text-white  text-center mb-5 text-5xl mt-5">EXPENSES TRACKER</h1>
      ...
      {!user && (
        ...
        <div className="flex flex-col items-center mt-15 w-full">
          {/* Inputs en fila */}
          <div className="flex flex-col sm:flex-col lg:flex-row gap-4 w-full justify-center items-center mb-6">
            {/* Fecha */}
            <div className="flex flex-col">
              <input id="date" type="date" name="date" value={form.date} onChange={handleChange} className="bg-gray-300 p-2 w-50 lg:w-33 rounded border placeholder-gray-400" required />
            </div>

            {/* Categoria */}
            <div className="flex flex-col ">
              <Listbox value={form.category} onChange={val => setForm({...form, category: val})}>
                <div className="relative w-50 lg:w-33">
            ...
            {/* Descripción */}
            <div className="flex flex-col">
              <input id="description" type="text" name="description" placeholder="Description" value={form.description} onChange={handleChange} className="bg-gray-300 p-2 rounded border border-gray-300 w-50  lg:w-50" required />
            </div>
            ...
            <div className="flex flex-col">
              <select
                ...
                className="bg-gray-300 p-2.5 rounded border border-gray-300 text-black w-50 lg:w-35"
              >
