    ...
    return (
        <div {...handlers} className="w-full h-full">
            {!hidePrev && (
                <button
                    onClick={goPrev}
                    className="fixed bottom-100 left-4 z-50  text-white px-2 py-2 hover:text-cyan-700"
                >
            ...
            <button
                onClick={goNext}
                className="fixed bottom-100 right-4 z-50 text-white px-2 py-2  hover:text-cyan-700"
            >
