    ...
    return (
        <div {...handlers} className="w-full h-full">
            {!hidePrev && (
                <button
                    onClick={goPrev}
                    className="fixed bottom-5 md:bottom-20 left-0 md:left-10 z-50  text-white px-2 py-2 hover:text-cyan-700"
                >
            ...
            <button
                onClick={goNext}
                className="fixed bottom-5 md:bottom-20 right-0 md:right-10 z-50 text-white px-2 py-2  hover:text-cyan-700"
            >
