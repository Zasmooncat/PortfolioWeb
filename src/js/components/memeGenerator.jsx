...
import ProjectNavigation from "../components/ProjectNavigation"; // <-- Asegúrate de ajustar la ruta
...
const MemeGenerator = () => {
    ...
    return (
        ...
        <div className="relative min-h-screen w-full">
                ...
                <div className="left w-[50%]">
                    ...
                    <div className="inputs flex ms-13 mt-5">
                        <div className="flex flex-col">
                            <label className="text-gray-400 me-3" htmlFor="top">
                                Text Top
                            </label>
                            <input
                        ...
                        <div className="flex flex-col">
                            <label className="text-gray-400 me-3" htmlFor="bottom">
                                Text Bottom
                            </label>
                            <input
                                className="bg-black border-2 w-60 mb-2 border-white placeholder-gray-500 px-3 py-1 rounded text-white me-5"
            ...
            {/* ✅ Botones Prev / Next fijos en las esquinas */}
            <ProjectNavigation />
        </div>
                    </>
    );
